...
import campaignHero from "../assets/CampaignManage.jpeg"; // Replace with your actual image path
import strategyIcon from "../assets/StrategyPlanning.jpg"; // Replace with your actual icon path
import analyticsIcon from "../assets/PerformacnceTracking.jpg";
import communicationIcon from "../assets/MessageDevlopment.jpg";
